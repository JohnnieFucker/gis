...
// 创建自定义的ArcGIS World Imagery瓦片图层类
...
function arcgisTileLayer(options) {
    return new ArcGISTileLayer("", options);
}
    ...
    vehicles = results
        ...
        .map((result) => {
            ...
            return {
                ...
                currentLocation: {
                    lat: result.realtime_datas.latitude,
                    lng: result.realtime_datas.longitude
                },
